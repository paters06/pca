...
gfortran -c -fcheck=all -Wall -g -fbounds-check refinement_example_2.f90 curve_refinement.o utils.o bspline_basis_functions.o nurbs_curve_module.o
gfortran -fcheck=all -Wall -o refinement_example_2 refinement_example_2.o curve_refinement.o utils.o bspline_basis_functions.o nurbs_curve_module.o
